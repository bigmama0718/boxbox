...
$sql_select = 'SELECT cID,cName,cSex,cBirthday,cEmail,cPhone,cAddr
FROM students WHERE cID=?';
$stmt = $db_link->prepare($sql_select);
$stmt->bind_param('i',$_GET['id']);
$stmt->execute();
$stmt->bind_result($cid,$cname,$csex,$cbirthday,$cemail,$cphone,
$caddr);
$stmt->fetch();
 ?>
<html>
      ...
      <table border='1' align='center' cellpadding='4'>
        ...
        <tr>
          <td colspan='2' align='center'>
            ...
            <input type="submit" name="button" id='button' value="確定刪除這筆資料">
          </td>
        </tr>
      </table>
    </form>
